...
public class Event implements org.apache.thrift.TBase<Event, Event._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final org.apache.thrift.protocol.TField FESTIVAL_FIELD_DESC = new org.apache.thrift.protocol.TField("festival", org.apache.thrift.protocol.TType.I32, (short)2);
  ...
  public int festival; // optional

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    EVENT((short)1, "event"),
    FESTIVAL((short)2, "festival");
  ...
  private static final int __FESTIVAL_ISSET_ID = 1;
  private byte __isset_bitfield = 0;
  private _Fields optionals[] = {_Fields.EVENT,_Fields.FESTIVAL};
  ...
  public Event setEvent(int event) {
    this.event = event;
    setEventIsSet(true);
    return this;
  }
  ...
  public Event setFestival(int festival) {
    this.festival = festival;
    setFestivalIsSet(true);
    return this;
  }

  public void unsetFestival() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __FESTIVAL_ISSET_ID);
  }

  /** Returns true if field festival is set (has been assigned a value) and false otherwise */
  public boolean isSetFestival() {
    return EncodingUtils.testBit(__isset_bitfield, __FESTIVAL_ISSET_ID);
  }

  public void setFestivalIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __FESTIVAL_ISSET_ID, value);
  }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case FESTIVAL:
      return Integer.valueOf(getFestival());
  ...
  public int hashCode() {
    ...
    boolean present_festival = true && (isSetFestival());
    builder.append(present_festival);
    if (present_festival)
  ...
  public int compareTo(Event other) {
    ...
    if (isSetFestival()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.festival, typedOther.festival);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class EventStandardScheme extends StandardScheme<Event> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Event struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetFestival()) {
        ...
        oprot.writeI32(struct.festival);
        oprot.writeFieldEnd();
      }
